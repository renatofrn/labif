    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codigo', models.CharField(help_text='Código para composição de turmas e matrículas', max_length=10, unique=True, verbose_name='Código Matricula')),
        ...
        migrations.AlterModelOptions(
            name='matricula',
            options={'ordering': ['matricula'], 'verbose_name': 'Matricula de Aluno', 'verbose_name_plural': 'Matriculas de Alunos'},
        ),
        ...
        migrations.AddField(
            model_name='matricula',
            name='aluno',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, related_name='comum_aluno', to='comum.aluno', verbose_name='Aluno'),
